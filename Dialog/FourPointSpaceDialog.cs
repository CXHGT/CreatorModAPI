...
namespace CreatorModAPI
{
    public class FourPointSpaceDialog : InterfaceDialog
    {
        ...
        public FourPointSpaceDialog(CreatorAPI creatorAPI) : base(creatorAPI)
        {
            ...
            base.GeneralSet();
            this.Children.Find<LabelWidget>("名称", true).Text = "4点空间";
        ...
        public override void Update()
        {
            ...
            if (this.OKButton.IsClicked)
            {
                Task.Run(() =>
                {
                    ...
                    foreach (Point3 point3 in creatorAPI.creatorGenerationAlgorithm.FourPointSpace(creatorAPI.Position[0], creatorAPI.Position[1], this.creatorAPI.Position[2],this.creatorAPI.Position[3]))
                    {
