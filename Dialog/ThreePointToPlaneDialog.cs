...
namespace CreatorModAPI
{
    public class ThreePointToPlaneDialog : InterfaceDialog
    {
        ...
        public ThreePointToPlaneDialog(CreatorAPI creatorAPI) : base(creatorAPI)
        {
            ...
            base.GeneralSet();
            this.Children.Find<LabelWidget>("名称", true).Text = "3点成面";
        ...
        public override void Update()
        {
            ...
            if (this.OKButton.IsClicked)
            {
                Task.Run(() =>
                {
                    ...
                    foreach (Point3 point3 in creatorAPI.creatorGenerationAlgorithm.ThreePointPlane(creatorAPI.Position[0], creatorAPI.Position[1],this.creatorAPI.Position[2]))
                    {
